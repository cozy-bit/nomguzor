  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:py-12">
      ...
      <div className="mb-6">
        <Link
          href="/"
          className="inline-flex items-center gap-1.5 text-xs font-semibold text-slate-500 hover:text-emerald-600 dark:text-zinc-400 dark:hover:text-emerald-400 transition-colors"
        >
      ...
      <article className="overflow-hidden rounded-3xl border border-slate-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-900/60 backdrop-blur-md sm:p-10">
        ...
        <div className="mt-8 grid grid-cols-1 gap-6 sm:grid-cols-2">
          ...
          <div className="rounded-2xl bg-slate-50 p-5 border border-slate-100 dark:bg-zinc-900/80 dark:border-zinc-800/80 sm:col-span-2">
            ...
            <p className="mt-2 text-base leading-relaxed text-slate-700 dark:text-zinc-300">
              {nameItem.meaning ||
        ...
        {/* Share Section */}
        <div className="mt-8 border-t border-slate-100 dark:border-zinc-800/80 pt-6">
          <ShareButtons
            name={nameItem.name}
            translit={nameItem.translit}
            slug={nameItem.slug}
