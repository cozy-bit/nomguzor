...
export default function RootLayout({
  ...
  return (
    <html lang="tg" className="h-full scroll-smooth">
      <body className="flex min-h-full flex-col bg-slate-50/70 text-slate-900 antialiased selection:bg-emerald-500/20 selection:text-emerald-800 dark:bg-slate-950 dark:text-slate-100 dark:selection:bg-emerald-500/30 dark:selection:text-emerald-300">
        <Header />
